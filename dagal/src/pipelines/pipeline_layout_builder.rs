...
impl PipelineLayoutBuilder {
	...
	pub fn push_push_constant_ranges(mut self, mut push_constant: Vec<vk::PushConstantRange>) -> Self {
	...
	pub fn build(self, device: crate::device::LogicalDevice, flags: vk::PipelineLayoutCreateFlags) -> Result<crate::pipelines::PipelineLayout> {
		...
		crate::pipelines::PipelineLayout::new(device, &pipeline_ci)
	}
}