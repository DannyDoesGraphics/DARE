...
impl<A: Allocator> SurfaceSOA<A> {
    pub fn new(mut allocator: ArcAllocator<A>, device: dagal::device::LogicalDevice) -> anyhow::Result<Self> {
        let usage_flags: vk::BufferUsageFlags = vk::BufferUsageFlags::STORAGE_BUFFER | vk::BufferUsageFlags::TRANSFER_DST | vk::BufferUsageFlags::TRANSFER_SRC | vk::BufferUsageFlags::SHADER_DEVICE_ADDRESS;
        Ok(Self {
            visibility_buffer_mask: PersistentBuffer::new(
                GrowableBuffer::new(
            ...
            transform_buffer_addresses: PersistentBuffer::new(
                GrowableBuffer::new(
                    dagal::resource::BufferCreateInfo::NewEmptyBuffer {
                        device: device.clone(),
            ...
            minimum_buffer_addresses: PersistentBuffer::new(
                GrowableBuffer::new(
                    dagal::resource::BufferCreateInfo::NewEmptyBuffer {
                        device: device.clone(),
            ...
            maximum_buffer_addresses: PersistentBuffer::new(
                GrowableBuffer::new(
                    dagal::resource::BufferCreateInfo::NewEmptyBuffer {
                        device: device.clone(),
            ...
            material_buffer_addresses: PersistentBuffer::new(
                GrowableBuffer::new(
                    dagal::resource::BufferCreateInfo::NewEmptyBuffer {
                        device: device.clone(),
            ...
            surface_flag_buffer_addresses: PersistentBuffer::new(
                GrowableBuffer::new(
                    dagal::resource::BufferCreateInfo::NewEmptyBuffer {
                        device: device.clone(),
            ...
            index_count_buffer_addresses: PersistentBuffer::new(
                GrowableBuffer::new(
                    dagal::resource::BufferCreateInfo::NewEmptyBuffer {
                        device: device.clone(),
