...
impl SurfacesContext {
    pub fn new(frame_in_flight: u32, device: &dagal::device::LogicalDevice, allocator: &mut ArcAllocator<GPUAllocatorImpl>) -> 
    Result<Self, dagal::DagalError> {
        let surface_buffers = (0..frame_in_flight).map(|index| {
                dagal::resource::Buffer::new(
                    dagal::resource::BufferCreateInfo::NewEmptyBuffer {
                        ...
                        size: vk::DeviceSize::from(std::mem::size_of::<crate::render::c::CSurface>() as u64 * 256u64),
