...
pub struct AssetManager {
    ttl: u16,
    geometry_descriptions: dare_containers::slot_map::SlotMap<GeometryDescription, GeometryDescriptionHandle>,
    geometry_runtime: HashMap<GeometryDescriptionHandle, std::sync::Arc<crate::geometry::GeometryRuntime>>,
...
impl AssetManager {
    ...
    pub fn create_geometry(&mut self, geometry: crate::GeometryDescription) -> crate::GeometryDescriptionHandle {
    ...
    pub fn remove_geometry(&mut self, handle: crate::GeometryDescriptionHandle) -> Option<crate::GeometryDescription> {
        self.geometry_descriptions.remove(handle).inspect(|_| {
